...
must_haves:
  truths:
    - "All workflows encode pair programming philosophy (thinking partners, not visionary/builder)"
    - "Agent proposes hypotheses and challenges user assumptions in all workflows"
    - "All workflows include first-turn protocol (talk before write)"
    - "All workflows end responses with [YOUR TURN] or explicit handoff"
    - "No workflow references deprecated STATE.md"
  artifacts:
