...
**README Structure:**
- Philosophy section — Why pair programming approach? Why perpetual WORK.md?
- Artifact overview — What each file does, how they connect
- Typical session walkthrough — Example of moodboard → exploration → execution → housekeeping
- Workflow diagram — Mermaid showing artifact lifecycle and workflow routing

**Maintainer's Guide (Semantic CICD):**

Add a "For Maintainers" section directly in README with:
1. **Testing new workflows** — How to verify changes work (eval framework, golden samples)
2. **Updating README** — When to update, what tone to use, what examples to include
3. **Preserving the vision** — Core principles that must not regress (pair programming, exploration > tasks, etc.)

This acts as "semantic CICD" — guiding future agents/humans on how to iterate while preserving the vision.
